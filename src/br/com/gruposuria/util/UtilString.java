...
public final class UtilString {
	...
	public static String retirarCaracteresEspeciais(String texto) {
		...
		textoLimpo = textoLimpo.replaceAll("[^\\p{ASCII}]", "");
	...
	public String substituirStringSe(boolean condicao, String srcString,
		...
		if (condicao) {
			srcString = substituirString(srcString, localizar, seVerdadeiro);
		} else {
			srcString = substituirString(srcString, localizar, seFalso);
		}
	 ...
	 */
	public String completarAEsquerda(String srcString, String novaString,
			int tamanho) {
